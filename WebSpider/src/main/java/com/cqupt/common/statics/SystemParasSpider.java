...
import com.cqupt.common.utils.OperatorSystemUtil;
 ...
 * 
 */
public class SystemParasSpider {
	// 日志
	public static MyLogger logger = new MyLogger(SystemParasSpider.class);

	public static ReadConfigUtil readConfigUtil = new ReadConfigUtil(
			"spider_config.properties", true);
