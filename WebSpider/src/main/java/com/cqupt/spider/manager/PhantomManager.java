...
public class PhantomManager {
	...
	public static CrawlConfigParaPojo crawlKeywordSeg4MetaSearch(
		...
		String config_para_json_path = SystemParasSpider.phantomjs_crawl_config_js_para_root_path
	...
	public static String getCrawlJsFilePath(String root_url) {
	 ...
	 if (root_url.contains("baidu.com")) {
		 ...
		 else if (root_url.contains("sina.com")) {
				return StaticValue.phantomjs_js_crawl_4_sina_news;
			}
	...
	private static String getPhantomjsConfigFilePath(
		...
		String phantomjs_config_path = SystemParasSpider.phantomjs_crawl_config_json_root_path
		...
		if (proxyPojo != null) {
			...
			phantomjs_config_path = SystemParasSpider.phantomjs_crawl_config_json_root_path
