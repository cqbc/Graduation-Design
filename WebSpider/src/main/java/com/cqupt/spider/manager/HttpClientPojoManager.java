...
public class HttpClientPojoManager {
	...
	public static void init() {
		...
		if (SystemParasSpider.proxy_open) {
			...
			for (ProxyPojo proxyPojo : SystemParasSpider.proxyList) {
		...
		config_builder.setSocketTimeout(SystemParasSpider.http_connection_timeout);
		config_builder.setConnectTimeout(SystemParasSpider.http_read_timeout);
	...
	public static class HttpClientPojo {
		...
		private HttpClientPojo(ProxyPojo proxyPojo) {
			if (proxyPojo == null || (!proxyPojo.isAuthEnable())) {
				...
				config_builder
						.setSocketTimeout(SystemParasSpider.http_connection_timeout);
				config_builder.setConnectTimeout(SystemParasSpider.http_read_timeout);
