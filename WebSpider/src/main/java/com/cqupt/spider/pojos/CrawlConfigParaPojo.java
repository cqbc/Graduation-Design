...
import com.cqupt.common.utils.MD5OperatorUtil;
...
public class CrawlConfigParaPojo {
	private MD5OperatorUtil md5 = new MD5OperatorUtil();
	...
	public CrawlConfigParaPojo(String root_url, String searchKeyword, int flag) {
		...
		if (searchKeyword != null) {
			...
			keyword_md5_add_seq = PhantomManager
					...
					+ this.keyword_md5
					+ StaticValueOfRule.separator_file_path;
		}

		this.setFlag(flag);

		if (flag == 0) {
			this.setPic_capture_save_root_path(SystemParasSpider.phantomjs_crawl_config_capture_pic_root_path_seg);
			this.setData_write_to_file_root_path(SystemParasSpider.phantomjs_crawl_config_txt_root_path_seg);
			this.setIs_capture_pic(StaticValue.is_capture_pic_default_seg);
			// this.setBody_pic_or_txt_count(1);
		} else if (flag == 1) {
			this.setPic_capture_save_root_path(SystemParasSpider.phantomjs_crawl_config_capture_pic_root_path_body);
			this.setData_write_to_file_root_path(SystemParasSpider.phantomjs_crawl_config_txt_root_path_body);
			...
			this.random_url_output_path_body = SystemParasSpider.phantomjs_crawl_config_all_data_root_path_random_url
					+ yyyy_mm_dd
					+ StaticValue.random_url_body_data_dir_name
					+ this.root_url_md5;
			this.random_url_output_path_capture = SystemParasSpider.phantomjs_crawl_config_all_data_root_path_random_url
					+ yyyy_mm_dd
			 ...
			 */
			this.setData_write_to_file_root_path(SystemParasSpider.phantomjs_crawl_config_all_data_root_path_random_url
					+ yyyy_mm_dd + StaticValue.random_url_body_data_dir_name);
			this.setPic_capture_save_root_path(SystemParasSpider.phantomjs_crawl_config_all_data_root_path_random_url
		...
		this.setJquery_path(SystemParasSpider.phantomjs_crawl_config_jquery_path);
		...
		this.setNo_response_waitting_time_max(SystemParasSpider.phantomjs_crawl_config_no_response_waitting_time_max);
		this.setNo_response_waitting_fail_time_max(SystemParasSpider.phantomjs_crawl_config_no_response_waitting_fail_time_max);
	}
